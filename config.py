...
class AppConfig:
    ...
    whisper_beam_size: int = _get_int("WHISPER_BEAM_SIZE", 2)
    whisper_best_of: int = _get_int("WHISPER_BEST_OF", 1)
    whisper_use_vad: bool = _get_bool("WHISPER_USE_VAD", False)
    whisper_retry_without_vad: bool = _get_bool("WHISPER_RETRY_WITHOUT_VAD", True)
